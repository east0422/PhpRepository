...
class DBApi {
    ...
    // 查询所有记录
    public function queryAll($tbname) {
    ...
    // 查询tbname表中id对应的记录
    public function queryById($tbname, $id) {
    ...
    // 删除某一条记录数据
    public function deletebyid($tbname, $id) {
    ...
    // 删除某些记录数据
    public function deletebyids($tbname, $uids) {
